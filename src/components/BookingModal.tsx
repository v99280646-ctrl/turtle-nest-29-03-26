...
const bookingOptions = [
  ...
  { id: "fun-dives", title: "Fun Dives", type: "experience" as const },
  { id: "experience-program-try-scuba", title: "Experience Program - Try Scuba Dive", type: "experience" as const },
  { id: "experience-program-discover-scuba", title: "Experience Program - The PADI Discover Scuba Diving", type: "experience" as const },
  { id: "dive-trip-perumal-par", title: "Dive Trip - Perumal Par Premium Dive Expedition", type: "trip" as const },
  { id: "dive-trip-lakshadweep-experience", title: "Dive Trip - Lakshadweep Divetrip Experience", type: "trip" as const },
];
...
const BookingModal = ({ open, onClose, defaultCourse = "", defaultPackage = "" }: BookingModalProps) => {
  ...
  const selectedBookingOption = bookingOptions.find((item) => item.id === selectedCourse);
