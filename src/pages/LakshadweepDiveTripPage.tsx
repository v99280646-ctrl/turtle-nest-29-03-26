          ...
          >
            <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
              <div className="relative min-h-[320px] overflow-hidden">
                <img
                  src={discoverScuba}
                  alt="Lakshadweep dive trip experience"
              ...
              <div className="p-6 md:p-8 lg:p-10">
                <p className="font-body text-xs uppercase tracking-[0.22em] text-foreground/45">
                  Lakshadweep Divetrip Experience
                </p>
                <h1 className="mt-3 font-heading text-3xl font-bold leading-tight md:text-5xl">
                  Dive Deeper into{" "}
                  <span className="gradient-text">Lakshadweep</span>
                </h1>
                <p className="mt-4 font-body text-sm leading-relaxed text-foreground/68 md:text-lg">
                  Explore vibrant coral reefs, crystal-clear waters, and
                  world-class dive sites across Bangaram, Parali, and
                  Thinnakara. A complete diving journey designed for certified
                  divers seeking adventure, comfort, and unforgettable marine
                  encounters.
                </p>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              ...
              <p className="font-body text-sm md:text-base leading-relaxed text-foreground/72">
                Discover the true beauty of Lakshadweep through a curated
                multi-day dive experience. This journey combines stunning reef
                dives across multiple islands, rich marine biodiversity,
                professionally guided dives, and comfortable beachside stays.
              </p>
              <p className="mt-4 font-body text-sm md:text-base leading-relaxed text-foreground/72">
                Each dive is carefully planned based on your experience level to
                ensure a safe, smooth, and memorable underwater journey.
              </p>
