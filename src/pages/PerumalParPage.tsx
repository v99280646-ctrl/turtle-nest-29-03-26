        ...
        >
          <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
            <div className="relative min-h-[320px] overflow-hidden">
              <img src={stayResort} alt="Perumal Par dive expedition" className="h-full w-full object-cover" />
            ...
            <div className="p-6 md:p-8 lg:p-10">
              <p className="font-body text-xs uppercase tracking-[0.22em] text-foreground/45">Perumal Par - Premium Dive Expedition</p>
              <h1 className="mt-3 font-heading text-3xl font-bold leading-tight md:text-5xl">
                Dive the <span className="gradient-text">Unexplored</span> - Perumal Par Expedition
              </h1>
              <p className="mt-4 font-body text-sm leading-relaxed text-foreground/68 md:text-lg">
                Experience one of Lakshadweep's most exclusive and untouched dive sites. A rare offshore expedition crafted for certified divers seeking elite, world-class underwater adventures.
              </p>

              <div className="mt-6 grid gap-3 sm:grid-cols-3">
                <div className="glass-card rounded-2xl p-4">
                  <p className="font-body text-[11px] uppercase tracking-[0.16em] text-foreground/40">Trip Length</p>
                  <p className="mt-2 font-heading text-xl font-bold">4 Days</p>
                </div>
                <div className="glass-card rounded-2xl p-4">
                  <p className="font-body text-[11px] uppercase tracking-[0.16em] text-foreground/40">Dive Day</p>
                  <p className="mt-2 font-heading text-xl font-bold">3 Expedition Dives</p>
                </div>
                <div className="glass-card rounded-2xl p-4">
                  <p className="font-body text-[11px] uppercase tracking-[0.16em] text-foreground/40">Price</p>
                  <p className="mt-2 font-heading text-xl font-bold text-accent">INR 70,000</p>
                </div>
              </div>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            <p className="font-body text-sm md:text-base leading-relaxed text-foreground/72">
              Perumal Par is among the most premium and least explored dive locations in Lakshadweep. Situated far offshore, this pristine reef system offers crystal-clear visibility, thriving coral ecosystems, pelagic species encounters, and minimal human interference.
            </p>
            <p className="mt-4 font-body text-sm md:text-base leading-relaxed text-foreground/72">
              This is not a routine dive. It is a full-day offshore expedition designed for divers who want something extraordinary, rare, and world-class.
            </p>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <div className="rounded-2xl border border-primary/20 bg-primary/10 p-5">
              <p className="font-body text-sm uppercase tracking-[0.16em] text-foreground/45">Expedition Package</p>
              <p className="mt-2 font-heading text-3xl font-bold">INR 70,000</p>
          ...
          >
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="font-heading text-2xl md:text-3xl font-bold">Why Choose Perumal Par?</h2>
            </div>
